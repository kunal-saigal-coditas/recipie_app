...
import 'package:recipe_app/presentation/common/error_message_widget.dart';
import 'package:recipe_app/presentation/screens/forum_screen/bloc/forum_page_bloc.dart';
import 'package:recipe_app/presentation/screens/forum_screen/widgets/forum_challenges_widget.dart';
...
class ForumPageTabBarWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async {
        context.read<ForumPageBloc>().add(
        ...
        child: DefaultTabController(
          ...
          child: Column(
            children: [
              ...
              SizedBox(
                height: 541.h,
                child: BlocBuilder<ForumPageBloc, ForumPageState>(
                  builder: (context, state) {
                    if (state is ForumPageSuccessState) {
                      return TabBarView(
                        children: [
                          FeaturedTopicSectionWidget(
                            forumFeaturedTopicsDataList:
                                state.featuredTopicList,
                          ),
