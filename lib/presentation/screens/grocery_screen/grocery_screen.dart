  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: const GroceryPageBodyWidget(),
      ),
    );
  }
}

class GroceryPageBodyWidget extends StatelessWidget {
  const GroceryPageBodyWidget({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      onRefresh: () async {
        BlocProvider.of<GroceryPageBloc>(context).add(
          GroceryPageInitialEvent(),
        );
      },
      child: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              BlocBuilder<GroceryPageBloc, GroceryPageState>(
